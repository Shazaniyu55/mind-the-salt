...
// Dynamically import MDBModal components to prevent SSR issues
  ...
  return (
    <div className='dashboard' style={{ padding: 17 }}>
      <h3 className='d-flex align-items-center justify-content-between'>
        <Bold>Community Question</Bold> {width < 1024 && <MDBBtn color='dark' rounded size='sm' onClick={() => {
