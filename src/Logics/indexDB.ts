...
export function useIndexedDB(databaseName: string, storeName: string) {
  ...
  function deleteDatabase() {
    ...
    deleteRequest.onblocked = () => {
      console.error('Delete blocked. Close all other tabs with this site open.');
    };
  }

  return { addObject, getAllObjects, updateObject, deleteObject, deleteDatabase };
}
